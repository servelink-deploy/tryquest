...
const testimonials: {
...
}[] = [
  {
    ...
    children: () => 'Postgres + AI is amazing. @tryquest_app',
  },
  {
    name: 'Maze',
    login: 'mazeincoding',
  ...
  },
  {
    ...
    children: () => 'HOLY CRAP WHAT??? @tryquest_app where have you been? This is so much easier then pgadmin. IT ALSO has some really nice micro animations and interactions wow.',
  },
  {
    name: 'Ansh Rathod',
    login: 'anshrathodfr',
  ...
  },
  {
    ...
    children: () => '@tryquest_app is the best database viewer i ever used, no cap 🔥',
  },
  {
    name: 'Dominik',
    ...
    children: () => 'Not gonna lie I was looking for something like @tryquest_app a while ago but couldn\'t find it until now. I think I am in love with this 😍',
  },
  {
    name: 'Sorin Curescu',
    login: 'en3sis',
    ...
    children: () => 'If you're reading this, go download @tryquest_app now and thank me later! ;)',
  },
  {
    name: 'Berke',
    login: 'chef_berke',
    ...
    children: () => 'found my new favorite db tool if you work with postgresql, definitely check this out @tryquest_app',
  },
  {
    name: 'Alex Holovach',
    login: 'alex_holovach',
    ...
    children: () => 'wow I can query data at the speed of thought with @tryquest_app',
  },
  {
    name: 'Iza',
    login: 'izadoesdev',
    ...
    children: () => 'okay why did nobody tell me how sexy @tryquest_app is',
  },
]
