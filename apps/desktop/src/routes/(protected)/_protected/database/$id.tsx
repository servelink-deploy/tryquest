...
function DatabasePage() {
  ...
  return (
    <div className="min-h-[inherit] h-screen flex bg-gray-100 dark:bg-neutral-950/60 relative">
      <DatabaseSidebar />
      <div className="h-[calc(100%-(--spacing(4)))] w-[calc(100%-(--spacing(16))-(--spacing(2)))] m-2 ml-16 flex flex-col">
        <ResizablePanelGroup
          direction="vertical"
