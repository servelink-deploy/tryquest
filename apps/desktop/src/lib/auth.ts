...
export const CODE_CHALLENGE_KEY = 'tryquest.code_challenge'
export const BEARER_TOKEN_KEY = 'tryquest.bearer_token'
export const RESET_TOKEN_KEY = 'tryquest.reset_token'
...
export function successAuthToast(newUser: boolean) {
  toast.success(
    newUser
      ? 'Welcome to TryQuest! We\'re excited to help you manage your connections with ease. Get started by creating your first connection.'
